...
while True:
    ...
    #APPLE = pygame.image.load(os.path.join('png-transparent-red-apple-illustration-rento-dice-board-game-online-10-coins-mini-artist-drawing-for-kids-archery-apple-red-apple-game-food-fruit.png')).convert()
    #game_window.blit(APPLE, (square_size, square_size))
    #pygame.display.flip()
...
# game over conditions
    def game_over():
        ...
        game_window.blit(score_text, (frame_size_x/2 - 60, frame_size_y/2 + 60))
